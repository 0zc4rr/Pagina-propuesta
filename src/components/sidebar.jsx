...
import { SlArrowLeft, SlGraduation, SlPieChart, SlChart } from "react-icons/sl";
...
const linksArray = [
  ...
  },
  {
    ...
    icon: <SlGraduation />,
    to: "/seguimiento_academico",
  },
  {
    label: "Apoyo Estudiantil",
    icon: <SlPieChart />,
    to: "/apoyo_estudiantil",
  },
  {
    label: "Carreras Transformadoras",
    icon: <SlChart />,
    to: "/carreras_transformadoras",
  },
];
const Container = styled.div`
  ...
  .Logocontent {
    ...
    .imgcontent {
      ...
      cursor: pointer;
      transition: all 0.3s;
      transform: ${({ isOpen }) => (isOpen ? `scale(0.9)` : `scale(0.9)`)};
    }
    h2 {
